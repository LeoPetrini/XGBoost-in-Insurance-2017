...
objectName=paste("xgb",'NB','casdata', sep="_")
gridName=paste("bayesGrid", 'NB', 'casdata', sep="_")
...
# Save final model
best=(as.data.frame(which.min(c("big"=metric.big,"med"=metric.med,"small"=metric.small))))
objectName=paste("xgb",'CS','casdata', sep="_")
gridName=paste("bayesGrid", 'CS', 'casdata', sep="_")
File_name=paste("models/",objectName,".RData",sep="")
...
# Save final model
best=(as.data.frame(which.min(c("big"=metric.big,"med"=metric.med,"small"=metric.small))))
objectName=paste("xgb",'tweedie','casdata', sep="_")
gridName=paste("bayesGrid", 'tweedie', 'casdata', sep="_")
File_name=paste("models/",objectName,".RData",sep="")
